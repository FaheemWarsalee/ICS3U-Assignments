...
if (userChoiceComp) then
    ...
    isUserBearingWxS := finalBearing > 225 and finalBearing < 270
	...
	put "Bearing ", userBearing, " is S", (180-finalBearing), "E"
    elsif (isUserBearingSxW) then
	put "Bearing ", userBearing, " is S", (finalBearing-180), "W"
    elsif (isUserBearingNxW) then
	put "Bearing ", userBearing, " is N", (360-finalBearing), "W"
    end if
    
    %Checksif the user bearing be in NE, SE, SW, NW sector
     if (isUserBearingExN) then
	put "Bearing ", userBearing, " is E", (90-finalBearing), "N"
    elsif (isUserBearingExS) then
	put "Bearing ", userBearing, " is E", (finalBearing-90), "S"
    elsif (isUserBearingWxS) then
	put "Bearing ", userBearing, " is W", (270-finalBearing), "S"
    elsif (isUserBearingWxN) then
	put "Bearing ", userBearing, " is W", (finalBearing-270), "N"
    end if
end loop
