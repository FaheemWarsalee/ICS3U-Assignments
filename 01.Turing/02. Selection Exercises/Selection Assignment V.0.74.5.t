...
loop
	...
	loop
		...
		if (userAngle >= 0 and userAngle<=45) then
		    ...
		    if (userDirect2 = "n" or userDirect2 = "north" or userDirect2 = "e" or userDirect2 = "east" or userDirect2 = "s" or userDirect2 = "south" or userDirect2 = "w" or userDirect2 = "west" or userDirect1(1)not=userDirect2(2)) then %checks if user direction 2 is a valid option
