...
var finalAngleNE, finalAngleEN, finalAngleES, finalAngleSE, finalAngleSW, finalAngleWS, finalAngleWN, finalAngleNW : int
...
loop
	...
	loop
	    put "\nCompass Direction: " ..
	    get userDirect1
	    if (userDirect1 = "n" or userDirect1 = "N" or userDirect1 = "North" or userDirect1 = "north" or userDirect1 = "e" or userDirect1 = "E" or userDirect1 = "East" or userDirect1 = "east" or userDirect1 = "s" or userDirect1 = "S" or userDirect1 = "South" or userDirect1 = "South" or userDirect1 = "w" or userDirect1 = "W" or userDirect1 = "West" or userDirect1 = "west") then %checks if user direction 1 is a valid option
		put "Compass Angle: " ..
		get userAngle
		    if (userAngle >0 and userAngle<45) then
			 put "Compass Direction: " ..
		get userDirect2
		if (userDirect2 = "n" or userDirect2 = "N" or userDirect2 = "North" or userDirect2 = "north" or userDirect2 = "e" or userDirect2 = "E" or userDirect2 = "East" or userDirect2 = "east" or userDirect2 = "s" or userDirect2 = "S" or userDirect2 = "South" or userDirect2 = "South" or userDirect2 = "w" or userDirect2 = "W" or userDirect2 = "West" or userDirect2 = "west") then %checks if user direction 2 is a valid option
	...
	isAngleNE := finalAngleNE > 0 and finalAngleNE < 45
	isAngleEN := finalAngleEN > 45 and finalAngleEN < 90
	isAngleES := finalAngleES > 90 and finalAngleES < 135
	isAngleSE := finalAngleSE > 135 and finalAngleSE < 180
	isAngleSW := finalAngleSW > 180 and finalAngleSW < 225
	isAngleWS := finalAngleWS > 225 and finalAngleWS < 270
	isAngleWN := finalAngleWN > 270 and finalAngleWN < 315
	isAngleNW := finalAngleNW > 315 and finalAngleNW < 360
    end if
    %Outputs
    if (userChoiceBear) then
	...
	if (isAngleEN) then
	    put "Compass E", userAngle, chr(186), "N is bearing ", finalAngleEN
	elsif (isAngleES) then
	    put "Compass E", userAngle, chr(186), "S is bearing ", finalAngleES
	elsif (isAngleSE) then
	    put "Compass S", userAngle, chr(186), "E is bearing ", finalAngleSE
	end if    
    end if
    %End of Program
