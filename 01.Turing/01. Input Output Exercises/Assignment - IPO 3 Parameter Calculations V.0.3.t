...
finalInvestmentAmount := round(((userPositiveIntergerOne*1000)*(1+(userPositiveIntergerTwo/100))**userPositiveIntergerThree)*100)/100
    %End of Processing Part 2: Compound Interest on an Investment
    
    %Part 3: Distance From a Point to the Origin in Three Dimensions
distanceFromOrigin3D := round(sqrt((userPositiveIntergerOne**2)+(userPositiveIntergerTwo**2)+(userPositiveIntergerThree**2))*10)/10
...
put "\nDistance from Origin (0,0,0), to (", userPositiveIntergerOne, ",", userPositiveIntergerTwo, ",", userPositiveIntergerThree, ")"
