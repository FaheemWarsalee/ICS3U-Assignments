...
class MethodsAssignmentL4PV2
{
  ...
  //STATES WHO WINS
  public static void stateWinner(String p1, String p2,int[] scoreCounter)
  {
    if (winnerIsP1(scoreCounter))
    {
      System.out.println(p1 + " Wins");
    }
    else if(winnerIsP2(scoreCounter))
    {
      System.out.println(p2 + " Wins");
    }
    else if(winnerIsP3(scoreCounter))
    {
  ...
  //Player 1 wins
  public static boolean winnerIsP1(int[] scoreCounter)
  {
  ...
  //Player 2 wins
  public static boolean winnerIsP2(int[] scoreCounter)
  {
    if(scoreCounter[3] ==3 && scoreCounter[4] == 5 && scoreCounter[5] == 3)
    {
      return false;
    }
    else
  ...
  //COMPUTER WINS
  public static boolean winnerIsP3(int[] scoreCounter)
  {
    if(scoreCounter[6] ==3 && scoreCounter[7] == 5 && scoreCounter[8] == 3)
    {
      return false;
    }
    else
  ...
  {
    if((scoreCounter[0] ==3 && scoreCounter[1] == 5 && scoreCounter[2] == 3 )|| 
       (scoreCounter[3] == 3 && scoreCounter[4] == 5 && scoreCounter[5] ==3) || 
       (scoreCounter[6] == 3 && scoreCounter[7] ==5 &&scoreCounter[8] == 3) )
    {
      return false;
    }
    else
  ...
  public static void main(String[] args)
  {
    ...
    do
    {
      ...
      else
      {
        ...
        stateWinner(userName1, userName2, scoreCounts);
      }
    }
